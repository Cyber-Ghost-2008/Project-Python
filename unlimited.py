...
def create_popup():
    ...
    hacked_window = tk.Tk()
    hacked_window.title("Don't touch my PC!")
...
def main():
    ...
    ascii_art = """
  _____              _ _     _______               _       __  __         _____   _____ _ 
 |  __ \            ( ) |   |__   __|             | |     |  \/  |       |  __ \ / ____| |
 | |  | | ___  _ __ |/| |_     | | ___  _   _  ___| |__   | \  / |_   _  | |__) | |    | |
 | |  | |/ _ \| '_ \  | __|    | |/ _ \| | | |/ __| '_ \  | |\/| | | | | |  ___/| |    | |
 | |__| | (_) | | | | | |_     | | (_) | |_| | (__| | | | | |  | | |_| | | |    | |____|_|
 |_____/ \___/|_| |_|  \__|    |_|\___/ \__,_|\___|_| |_| |_|  |_|\__, | |_|     \_____(_)
                                                                   __/ |                  
                                                                  |___/                   
"""
